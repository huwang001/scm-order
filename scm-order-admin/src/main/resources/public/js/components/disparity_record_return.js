lyfdefine(['disparity_duty'], function (dutyMode) {
    return ({
        data: function data() {
            return {
                dataForm: {
        ...
        methods: {
            ...
            getDataList: function getDataList() {
                ...
                this.$http.post('/scm-order-admin/stock/disparity_record/query_by_condition', this.dataForm,
                ).then(function (_ref) {
                    ...
                    if (data && data.list) {
                        ...
                        if(data.list.length>0){
                            _this.factoryCode = data.list[0].inFactoryCode;
                        }
                    } else {
            ...
            duty: function () {
                ...
                this.$refs.dutyMode.init(2, this.multipleSelection,[]);
            },
            //模糊查询
            querySearch: function (queryString, cb) {
                let _this = this;
                let list = [];
                this.$http.post('/scm-order-admin/admin/v1/whAllocation/queryForAdmin?name=' + queryString).then(function (res) {
                    if (res.status == '200') {
            ...
            handle: function () {
                ...
                _this2.$confirm('确定执行过账操作吗, 是否继续?', '提示', {
                    ...
                    _this2.$http.post('/scm-order-admin/stock/disparity_record/handlerDisparity?',ids)
                        .then(function (_ref2) {
            ...
            buttonController: function () {
                ...
                //只有当用户选中了交货单号，并且该单子处于已定责状态时，才能确认过账
            ...
            exportExcel: function exportExcel() {
                ...
                _this.loading = true;
                _this.$http.post('/scm-order-admin/stock/disparity_record/exportDisparityRecords', _this.dataForm,
                ).then(function (_ref) {
                    if (_ref.data && _ref.data.code === '0') {
                        _this.downloadFile(_ref.data.data.name, 'data:text/plain;base64,' + _ref.data.data.base64);
                    } else {
                        console.log(_ref.data.msg)
                        _this.$message({
   ...
   <el-form :inline="true" :model="dataForm" ref="dataForm" > <!--@keyup.enter.native="getDataList()">-->
        ...
        <el-form-item label="更新人" >
                        ...
                        <el-form-item label="单状态" prop="recordStatus">
                           ...
                           <el-form-item label="收货工厂" >
                            <el-input v-model="dataForm.factoryCode" placeholder="收货工厂" clearable/>
                        </el-form-item>
    ...
    @selection-change="handleSelectionChange"
     :element-loading-text="loadingStr" style="width: 100%;">
        ...
        <el-table-column prop="skuCode" header-align="center" align="center" label="商品Code"/>
