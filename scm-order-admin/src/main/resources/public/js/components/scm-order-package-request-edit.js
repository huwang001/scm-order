lyfdefine(['scm-order-package-select-product','scm-order-package-select-order'],function(ProductDialog,OrderDialog){
    return ({
            ...
            init() {
                ...
                this.$http({
                    ...
                    if (res.data.code === '0') {
                        ...
                        this.submitForm.recordCode = data.recordCode;
                        ...
                        this.submitForm.channelName = data.channelName;
                        this.submitForm.inRealWarehouseId = data.inRealWarehouseId;
                        this.submitForm.outRealWarehouseId = data.outRealWarehouseId;
                        this.submitForm.outFactoryCode = data.outFactoryCode;
                        this.submitForm.inFactoryCode = data.inFactoryCode;
                        ...
                        this.$http({
                            ...
                            params: {
                                factoryCode: this.submitForm.inFactoryCode,
                                realWarehouseType: 2
                            }
                        }).then(res => {
                    ...
                    this.$refs.submitForm.validate((valid) => {
                        if (valid) {
                            const _submitForm = {
                                ...
                                packDemandComponentDTOList: this.submitForm.packDemandComponentDTOList,
                                packDemandDetailDTOList: this.submitForm.packDemandDetailDTOList
                            }
                            this.loading = true
                            this.$http({
                                method: 'post',
        ...
        template: `
<el-dialog title="编辑包装需求单" data-scm-order-package class="scm-order-package-request-add" :visible.sync="visible" :close-on-click-modal="false" :beforeClose="handleBeforeClose" width="1200px">
                    ...
                    <el-row>
                        <el-col :span="6">
                            <el-form-item label="包装类型:" prop="packType" label-width="100px">
                                <el-select v-model="submitForm.packType" disabled style="width:100%" @change="handleChangePackageType">
                        ...
                        <el-col :span="6">
                            <el-form-item label="需求日期:" prop="demandDate" label-width="100px">
                                <el-date-picker style="width:100%;" type="date" v-model="submitForm.demandDate" placeholder="选择日期" clearable></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
