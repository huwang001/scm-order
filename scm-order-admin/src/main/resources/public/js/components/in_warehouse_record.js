lyfdefine(['in_warehouse_record_detail'], function (addOrUpdate) {
    return ({
        data: function () {
            return {
                dataList: [],
        ...
        methods: {
            ...
            getDataList: function getDataList() {
                ...
                this.$http.post('/scm-order-admin/order/v1/warehouse_record/in_warehouse_record/list',
                    this.dataForm
                ).then(function (res) {
                    if (res.status == '200') {
            ...
            getWarehouseRecordTypes: function getWarehouseRecordTypes() {
                let _this = this;
                this.$http.post('/scm-order-admin/order/show/queryInWarehouseRecordType/list'
                ).then(function (res) {
                    if (res.status == '200') {
            ...
            getWarehouseRecordStatuses: function getWarehouseRecordStatuses() {
                let _this = this;
                this.$http.post('/scm-order-admin/order/show/queryInWarehouseRecordStatus/list'
                ).then(function (res) {
                    if (res.status == '200') {
            ...
            initOriginTableTitles() {
                this.originTableTitles = [
                    {title: "入库单号", rowCode: "recordCode", prop: "recordCode", isShow: 1, orderNum: 1},
                    {title: "入库单状态", rowCode: "recordStatus", prop: "recordStatus", isShow: 1, orderNum: 2},
            ...
            <el-container>
                <el-main>
                    <el-row type="flex" justify="start" style="line-height:30px;height: 30px;font-size: 14px">
                         <el-col :span="2"><div style="font-weight: bold">入库单查询</div></el-col>
                    </el-row>
                    <el-form :inline="true" :model="dataForm" class="demo-form-inline">
                        ...
                        <el-form-item label="入库单类型" prop="recordType">
                        ...
                        <el-form-item label="入库单状态" prop="recordStatus">
