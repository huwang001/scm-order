    ...
    return ({
        ...
        methods: {
            init: function init() {
                ...
                this.clearForm();
                this.visible = true;
                _this.$http.get('/scm-order-admin/order/v1/whAllocation/initAddPage'
                ).then(function (res) {
                    if(res.status=='200'){
                        _this.dataForm.recordCode =res.data.data.recordCode;
                        _this.reasonList = res.data.data.reasonList;
                        _this.$set(_this.dataForm, 'isReturnAllotcate', "0");
                        _this.$set(_this.dataForm, 'isQualityAllotcate', "0");
                        _this.$set(_this.dataForm, 'allotTime', new Date());
            ...
            initSelectPage: function initSelectPage(){
                ...
                _this.prodForm.isQualityAllotcate = _this.dataForm.isQualityAllotcate;
                this.$http.post('/scm-order-admin/order/v1/whAllocation/queryStockByWhId',
                    _this.prodForm).then(function (res) {
                    if(res.status=='200'){
                    ...
                    if(_this.unitCodes != null) {
                        _this.unitCodes.forEach(function (obj) {
                            if (obj.lineNo == e.lineNo && obj.unitCode == e.unitCode) {
                                _this.unitInfos.set(e.lineNo, e);
                            }
                        });
                    }
                });
            ...
            itemFormSubmit: function () {
                ...
                _this.$refs['dataForm'].validate(function (valid) {
                    if (valid) {
                        ...
                        _this.dataList.forEach(function (e) {
                            if(e.allotQty == '' || e.allotQty == undefined){
                            ...
                            if(e.baseNum >= 0){
                                ...
                                let  stock = useQty - e.baseNum;
                                if(stock < 0) {
                                    _this.$message({message: '部分商品调拨数量小于库存数量！', type: 'error'});
                                    isSucc = false;
                                    return;
                                }else{
                                    _this.stockMap.set(e.skuId, stock);
                                }
                            }
                        ...
                        _this.$http.post('/scm-order-admin/order/v1/whAllocation/saveWhAllocation', _this.dataForm
                        ).then(function (_ref2) {
                            let data = _ref2.data;
                            if (data && data.code === '0') {
            ...
            clearForm: function(){
                ...
                _this.dataForm.inWarehouseId='';
                _this.dataForm.outWarehouseId='';
                _this.prodForm.realWarehouseId='';
                ...
                _this.dataForm.inWarehouseName='';
                _this.dataForm.inWarehouseMobile='';
                _this.dataForm.outWarehouseName='';
                _this.dataForm.outWarehouseMobile='';
                 ...
                 :visible.sync="visible">
                   ...
                   <el-dialog title="" :before-close="closeDialog" :visible.sync="prodDialogVisible" v-if="prodDialogVisible" append-to-body>
                       <el-form :inline="true" size="small" :model="dataForm" class="demo-form-inline" style="overflow: hidden">
                            <el-col :span="8">
                            <el-input   v-model="prodForm.realWarehouseId"  style="display:none;"></el-input>
                       ...
                       @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="skuCode" label="商品编号" width="140" sortable>
                        </el-table-column><i class="el-icon-sort"></i>
                        <el-table-column prop="skuName" label="商品名称" width="140">
                        </el-table-column>
